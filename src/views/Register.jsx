...
export default function Register() {
  ...
  return (
    <div className="min-h-[90vh] flex flex-col items-center justify-center bg-white px-6">
      {/* Navigation Link */}
      <Link href="/login" className="mb-12 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 hover:text-blue-600 transition-colors">
