...
export default function VerbisCard({ 
  image, 
  category, 
  headline, 
  author, 
  ...
  return (
    <div className="verbis-card group relative bg-white border border-slate-100 p-4 rounded-3xl transition-all duration-300 hover:shadow-xl hover:border-[var(--color-accent-light)]">
